              ...
              decoration: BoxDecoration(
                ...
                child: Row(
                  ...
                  Padding(
                    ...
                    child: Text("Sellers Requests (03)",style: TextStyles.openSans(fontWeight: FontWeight.w600,fontSize: 12.sp,),),
                  ),
                  Padding(
...
Padding(
  ...
  child: Container(
    decoration: BoxDecoration(shape: BoxShape.circle,color: Color(0xffFC8019)),
    child: Icon(Icons.expand_more,size: 15.sp,color: Colors.white,)),
)
